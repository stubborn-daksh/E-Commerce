        ...
        <Layout title={"Register - Ecommerce App"}>
            <div className='form-container'>
                ...
                <form onSubmit={handleSubmit}>
                    ...
                    <div className="mb-3">
                        <input type="text" value={answer} onChange={(e) => setAnswer(e.target.value)} className="form-control" id="exampleInputAnswer1" placeholder='Your First Crush Name' required />
                    </div>
